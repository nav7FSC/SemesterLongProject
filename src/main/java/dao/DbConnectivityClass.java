...
public class DbConnectivityClass {
    final static String DB_NAME = "singhdb";
    MyLogger lg = new MyLogger();
    final static String SQL_SERVER_URL = "jdbc:mysql://csc311singh.mysql.database.azure.com";
    final static String DB_URL = "jdbc:mysql://csc311singh.mysql.database.azure.com/singhdb";
    final static String USERNAME = "csc311singhadmin";
    final static String PASSWORD = "Farmingdale22##";
